...
\* Different coloured Category labels displayed directly before the sender
...
python dataset/create\_labels.py
...
python dataset/train\_model.py
...
python dataset/evaluate\_model.py
